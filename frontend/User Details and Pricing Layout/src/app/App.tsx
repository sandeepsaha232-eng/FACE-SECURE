...
import { FaceSecureLogo } from './components/FaceSecureLogo';
...
export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#071C2F] via-[#0A2A44] to-[#071C2F] relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative border-b border-[#1FB6C9]/30 bg-[#071C2F]/80 backdrop-blur-md">
      ...
      {/* Footer */}
      <footer className="relative border-t border-[#1FB6C9]/30 bg-[#071C2F]/80 backdrop-blur-md mt-24">
