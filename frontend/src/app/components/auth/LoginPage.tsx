...
import { Mail, Lock, Loader2, Facebook, Twitter, Chrome, Shield } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-[#020b14] flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#1FB6C9]/5 rounded-full blur-[120px]" />
            </div>
            ...
            >
                ...
                <div className="w-full md:w-5/12 relative bg-[#051322] p-12 flex flex-col justify-center items-start overflow-hidden">
                    {/* Decorative Circles */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] border border-[#1FB6C9]/20 rounded-full" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] border border-[#1FB6C9]/10 rounded-full" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] border border-[#1FB6C9]/5 rounded-full" />
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] opacity-20 pointer-events-none">
                        <svg viewBox="0 0 100 100" fill="none" stroke="#4CCFFF" strokeWidth="0.5">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            Log in to pick up right where you left off. We've missed you!
                        </motion.p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-7/12 p-8 md:p-12 bg-[#081b2e] flex relative">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="pt-4 flex items-center justify-between">
                                    <motion.button
                                        ...
                                        type="submit"
                                        disabled={loading}
                                        className="bg-[#1FB6C9] hover:bg-[#4CCFFF] text-[#071C2F] font-bold py-3 px-12 rounded shadow-[0_0_15px_rgba(31,182,201,0.3)] hover:shadow-[0_0_20px_rgba(76,207,255,0.5)] transition-all"
                                    >
                                        {loading ? <Loader2 className="animate-spin w-5 h-5" /> : 'Sign In'}
                                    </motion.button>

                                    <div className="text-sm text-gray-400">
                                        New member? <Link to="/signup" className="text-[#4CCFFF] hover:text-white transition-colors ml-1">Sign Up</Link>
                                    </div>
                                </div>
                            </form>
                        </motion.div>
                    ...
                    <div className="hidden md:flex flex-col items-center justify-center pl-8 border-l border-gray-700/50">
                        <div className="text-gray-500 font-medium mb-8 text-sm tracking-widest">OR</div>

                        <div className="flex flex-col gap-6">
                            <motion.button whileHover={{ y: -3 }} className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#071C2F] hover:bg-gray-200 transition-colors">
