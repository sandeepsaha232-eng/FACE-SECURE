                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs text-[#8FAEC6] font-medium ml-1">Your Email</label>
                                ...
                                {/* Password */}
                                <div className="space-y-1">
                                    <label className="text-xs text-[#8FAEC6] font-medium ml-1">Password</label>
                                    <div className="relative group">
                                        <input
                                            type="password"
                                            required
                                ...
                                <div className="flex justify-end">
                                    <Link to="/forgot-password" className="text-xs text-[#8FAEC6] hover:text-white transition-colors">
                                        Forgot Password?
                                    </Link>
                                </div>
