                    ...
                    <div className="flex-1 pr-8">
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                {/* Password */}
                                <div className="space-y-1">
                                    <label className="text-xs text-gray-400 font-medium ml-1">Create Password</label>
                                    <div className="relative group">
                                        <input
                                            type="password"
                                            required
                                ...
                                {/* Repeat Password */}
                                <div className="space-y-1">
                                    <label className="text-xs text-gray-400 font-medium ml-1">Repeat password</label>
                                    <div className="relative group">
                                        <input
                                            type="password"
                                            required
